...
int move_player(struct player* player, struct position newpos, struct map_tile map[MAP_Y][MAP_X]) {
...
bool check_player_descent(struct position pos, struct map_tile map[MAP_Y][MAP_X]) {
